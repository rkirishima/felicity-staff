 ...
 * 2026-05 更新: Mill City / Sweet Maria's / SCAJ ガイダンス + Rowly運用知見。
 *
...
export const PROFILES: RoastProfile[] = [
  // ═══════════════════ PNG BAROIDA WASHED ═══════════════════
  {
    ...
    charge_1kg_c: 208, charge_3kg_c: 226, fc_c: 200, drop_c: 215,
    total_time_min: '11:00', drum_rpm: 55, drum_note: 'standard',
  ...
  },
  {
    ...
    charge_1kg_c: 208, charge_3kg_c: 226, fc_c: 200, drop_c: 224,
    total_time_min: '12:30', drum_rpm: 55, drum_note: 'standard',
    heat_method: 'fast-ramp',
  ...
  // ═══════════════════ BRASIL SANTA ALINA ═══════════════════
  {
    ...
    charge_1kg_c: 200, charge_3kg_c: 218, fc_c: 198, drop_c: 213,
    total_time_min: '10:30', drum_rpm: 50, drum_note: 'standard',
  ...
  },
  {
    ...
    charge_1kg_c: 200, charge_3kg_c: 218, fc_c: 198, drop_c: 222,
    total_time_min: '11:30', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'steady-medium',
  ...
  // ═══════════════════ BRAZIL CERRADO ═══════════════════
  {
    ...
    charge_1kg_c: 202, charge_3kg_c: 220, fc_c: 199, drop_c: 214,
    total_time_min: '10:45', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'steady-medium',
  ...
  },
  {
    ...
    charge_1kg_c: 202, charge_3kg_c: 220, fc_c: 199, drop_c: 222,
    total_time_min: '11:30', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'steady-medium',
  ...
  // ═══════════════════ BRAZIL SANTOS ═══════════════════
  {
    ...
    charge_1kg_c: 198, charge_3kg_c: 216, fc_c: 197, drop_c: 215,
    total_time_min: '10:00', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'steady-medium',
  ...
  },
  {
    ...
    charge_1kg_c: 198, charge_3kg_c: 216, fc_c: 197, drop_c: 222,
    total_time_min: '11:00', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'steady-medium',
  ...
  // ═══════════════════ GUATEMALA LA CUPULA ═══════════════════
  {
    ...
    charge_1kg_c: 212, charge_3kg_c: 230, fc_c: 203, drop_c: 218,
    total_time_min: '11:30', drum_rpm: 55, drum_note: 'standard',
    heat_method: 'aggressive-steady',
    strategy: 'Antigua SHB。Full Cityでバランス。set & forgetで火を緩めない。',
  ...
  },
  {
    ...
    charge_1kg_c: 212, charge_3kg_c: 230, fc_c: 203, drop_c: 225,
    total_time_min: '12:30', drum_rpm: 55, drum_note: 'standard',
    heat_method: 'aggressive-steady',
  ...
  // ═══════════════════ GUATEMALA GUALVADOR (Anaerobic) ═══════════════════
  {
    ...
    charge_1kg_c: 205, charge_3kg_c: 223, fc_c: 200, drop_c: 213,
    total_time_min: '11:30', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
  ...
  },
  {
    ...
    charge_1kg_c: 205, charge_3kg_c: 223, fc_c: 200, drop_c: 220,
    total_time_min: '12:30', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
    heat_method: 'gradual-ramp',
  ...
  // ═══════════════════ ETHIOPIA YIRGACHEFFE G-1 NATURAL ═══════════════════
  {
    ...
    charge_1kg_c: 195, charge_3kg_c: 207, fc_c: 196, drop_c: 205,
    total_time_min: '10:00', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
  ...
  },
  {
    ...
    charge_1kg_c: 195, charge_3kg_c: 207, fc_c: 196, drop_c: 213,
    total_time_min: '11:00', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
    heat_method: 'gentle-controlled',
  ...
  // ═══════════════════ ETHIOPIA BANKO GOTITI ═══════════════════
  {
    ...
    charge_1kg_c: 198, charge_3kg_c: 210, fc_c: 197, drop_c: 204,
    total_time_min: '9:30', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-controlled',
  ...
  },
  {
    ...
    charge_1kg_c: 198, charge_3kg_c: 210, fc_c: 197, drop_c: 211,
    total_time_min: '10:30', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-controlled',
  ...
  // ═══════════════════ COLOMBIA DECAFE ═══════════════════
  {
    ...
    charge_1kg_c: 190, charge_3kg_c: 202, fc_c: 192, drop_c: 212,
    total_time_min: '11:30', drum_rpm: 50, drum_note: 'First crack quieter than usual',
    heat_method: 'very-gentle',
    strategy: 'EA処理で細胞壁脆い。低チャージ＋SOAK、Maillard伸ばしてボディ補強。',
  ...
  },
  {
    ...
    charge_1kg_c: 190, charge_3kg_c: 202, fc_c: 192, drop_c: 220,
    total_time_min: '12:30', drum_rpm: 50, drum_note: 'First crack quieter than usual',
    heat_method: 'very-gentle',
  ...
  // ═══════════════════ TANZANIA AA/AB MWIKA ═══════════════════
  {
    ...
    charge_1kg_c: 205, charge_3kg_c: 223, fc_c: 201, drop_c: 208,
    total_time_min: '10:30', drum_rpm: 50, drum_note: 'standard',
  ...
  },
  {
    ...
    charge_1kg_c: 205, charge_3kg_c: 223, fc_c: 201, drop_c: 213,
    total_time_min: '11:00', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-balanced',
  ...
  // ═══════════════════ INDIA ATTIKAN (Anaerobic) ═══════════════════
  {
    ...
    charge_1kg_c: 203, charge_3kg_c: 221, fc_c: 199, drop_c: 214,
    total_time_min: '11:30', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
    heat_method: 'gradual-ramp',
  ...
  },
  {
    ...
    charge_1kg_c: 203, charge_3kg_c: 221, fc_c: 199, drop_c: 221,
    total_time_min: '12:30', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
    heat_method: 'gradual-ramp',
  ...
  // ═══════════════════ YEMEN WHITE CAMEL ═══════════════════
  {
    ...
    charge_1kg_c: 195, charge_3kg_c: 207, fc_c: 196, drop_c: 210,
    total_time_min: '11:30', drum_rpm: 45, drum_note: 'NATURAL - 低RPMで flicking 防止',
    heat_method: 'gentle-controlled',
  ...
  // ═══════════════════ JAMAICA BLUE MOUNTAIN ═══════════════════
  {
    ...
    charge_1kg_c: 200, charge_3kg_c: 212, fc_c: 198, drop_c: 213,
    total_time_min: '11:00', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-balanced',
  ...
  // ═══════════════════ EL SALVADOR FANY ═══════════════════
  {
    ...
    charge_1kg_c: 205, charge_3kg_c: 223, fc_c: 200, drop_c: 208,
    total_time_min: '10:30', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-balanced',
  ...
  // ═══════════════════ PANAMA GEISHA ═══════════════════
  {
    ...
    charge_1kg_c: 193, charge_3kg_c: 205, fc_c: 195, drop_c: 204,
    total_time_min: '10:00', drum_rpm: 50, drum_note: 'standard',
    heat_method: 'gentle-controlled',
    strategy: '最も繊細。低チャージ＋SOAKで香り保護、FC+45-60秒即ドロップ。Light厳守。',
